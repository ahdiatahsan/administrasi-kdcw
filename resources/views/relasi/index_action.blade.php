<form action="{{ route('relasi.destroy', $relasi->id) }}" method="POST">
    ...
    <span class="dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-right"
            ...
            <a class="dropdown-item" href="{{ route('relasi.edit', $relasi->id) }}"><i class="la la-edit"></i>Ubah</a>
            <button type="button" class="dropdown-item" data-toggle="modal" data-target="#delete_modal-{{ $relasi->id }}">
    ...
    <!-- Modal -->
    <div class="modal fade" id="delete_modal-{{ $relasi->id }}" tabindex="-1" role="dialog" aria-hidden="true">
